...
![](/assets/img/2013-03-03-58ImgRecognize-1.jpg)

灰度图：

![](/assets/img/2013-03-03-58ImgRecognize-2.bmp)

二值化图：

![](/assets/img/2013-03-03-58ImgRecognize-3.bmp)
...
先用floodfill 把连片的点抽取出来，去除太小的片(杂点)，然后对其到(0,0)
